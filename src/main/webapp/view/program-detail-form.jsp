...
<f:form method="post" commandName="program" action="${ pageContext.request.contextPath }/program/edit">
	...
	<table id="program" border="0" cellspacing="0" >
		<tr>
			...
			<td><f:input path="code"/><br/><f:errors path="code"/></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><f:input path="startDateTime"/>(dd/mm/yyyy hh:mm)<br/><f:errors path="startDateTime"/></td>
		</tr>
		<tr>
			<td><f:label path="duration">Duration</f:label></td>
			<td><f:input path="duration"/><br/><f:errors path="duration"/></td>
		</tr>
		<tr>
